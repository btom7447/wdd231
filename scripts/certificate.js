document.addEventListener('DOMContentLoaded', function () {
    ...
    const buttons = document.querySelectorAll('.certificate-buttons button');
    const creditDisplay = document.createElement('p'); 
    creditDisplay.classList.add('credit-display');
    document.querySelector('.certificates').appendChild(creditDisplay);
    ...
    function renderCourses(filter = 'all') {
        ...
        filteredCourses.forEach(course => {
            ...
            courseCard.classList.add('certificate', course.subject.toLowerCase(), course.completed ? 'completed' : 'incomplete');
            ...
            `;
            certificateGrid.appendChild(courseCard);
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function () {
            const filter = button.classList.contains('all-btn') ? 'all' :
                           button.classList.contains('cse-btn') ? 'cse' :
                           button.classList.contains('wdd-btn') ? 'wdd' : 'all';
